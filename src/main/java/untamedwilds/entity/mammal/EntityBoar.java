        ...
        if (!this.level().isClientSide) {
            ...
            if (this.getAnimation() != NO_ANIMATION) {
                if (this.getAnimation() == ATTACK && this.getAnimationTick() == 8 && this.random.nextInt(3) == 0) {
                    this.playSound(ModSounds.ENTITY_BOAR_SQUEAL.get(), this.getSoundVolume(), this.getVoicePitch());
                }
            }
        }
        super.aiStep();
    ...
    public static class GoHogWildGoal extends Goal {
        ...
        public void tick() {
            if (this.boar.getRandom().nextInt(this.adjustedTickDelay(50)) < 3) {
                ...
                this.boar.playSound(ModSounds.ENTITY_BOAR_SQUEAL.get(), this.boar.getSoundVolume(), this.boar.getVoicePitch());
            }
