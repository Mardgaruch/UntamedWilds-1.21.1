...
// Removed OnlyIn import for compatibility
...
public class LayerFootballFishLure<T extends Entity, M extends EntityModel<T>> extends EyesLayer<T, M> {
    ...
    private final RenderType TEXTURE = RenderType.eyes(ResourceLocation.tryParse(UntamedWilds.MOD_ID + ":textures/entity/football_fish/glint.png"));
