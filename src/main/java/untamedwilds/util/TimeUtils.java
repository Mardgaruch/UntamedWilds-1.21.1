...
public abstract class TimeUtils {
    ...
    public static String convertTicksToDays(Level world, int ticks) {
        ...
        if (d > 7) {
            int m = d/7;
            d -= m * 7;
            return net.minecraft.network.chat.Component.translatable("untamedwilds.timeutils.weeks", m, d).getString();
        }
    return net.minecraft.network.chat.Component.translatable("untamedwilds.timeutils.days", d).getString();
    }
