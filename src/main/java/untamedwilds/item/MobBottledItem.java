...
public class MobBottledItem extends Item {
    ...
    return net.minecraft.network.chat.Component.translatable("item.untamedwilds.bottle_" + this.entity.get().builtInRegistryHolder().key().location().getPath() + "_" + EntityUtils.getVariantName(this.entity.get(), this.getSpecies(stack)));
    }
