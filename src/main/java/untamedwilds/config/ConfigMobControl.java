...
public class ConfigMobControl {
    ...
    ConfigMobControl(final ModConfigSpec.Builder builder) {
        ...
        dimensionBlacklist = builder.comment("Prevent mobs and burrows from spawning in the defined dimensions.").defineList("mobcontrol.dimensionBlacklist", Lists.newArrayList(), o -> o instanceof String);    }
}
