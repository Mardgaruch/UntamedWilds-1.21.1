...
public class TreeOrchidDecorator extends TreeDecorator {
    ...
    protected TreeDecoratorType<?> func_230380_a_() {
        // TODO 1.21.1: TREE_ORCHID is commented out, needs proper codec implementation
        return null; // UntamedWildsGenerator.TREE_ORCHID.get();
    }
            ...
            posList.stream().filter((p_236867_1_) -> {
                ...
                for (Direction direction : Direction.Plane.HORIZONTAL) {
                    if (rand.nextFloat() <= 0.25F) {
                        ...
                        if (worldIn.isStateAtPosition(blockpos, BlockState::isAir)) {
