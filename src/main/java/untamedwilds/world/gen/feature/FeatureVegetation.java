...
// replaced net.minecraftforge.common.Tags with BiomeTags where needed
...
public class FeatureVegetation extends Feature<ProbabilityFeatureConfiguration> {
    ...
    TEMPERATE_BUSH(ModBlock.BUSH_TEMPERATE.get(), 6, ConfigFeatureControl.addFlora.get(), false, 24, BiomeTags.IS_FOREST, ModBiomeTags.IS_SWAMP, ModBiomeTags.IS_MOUNTAIN, BiomeTags.IS_TAIGA, ModBiomeTags.IS_PLAINS),
    CREOSOTE_BUSH(ModBlock.BUSH_CREOSOTE.get(), 2, ConfigFeatureControl.addFlora.get(), false, 4, ModBiomeTags.IS_BADLANDS, ModBiomeTags.IS_DESERT),
        ELEPHANT_EAR(ModBlock.ELEPHANT_EAR.get(), 6, ConfigFeatureControl.addFlora.get(), false, 24, ModBiomeTags.IS_JUNGLE),
        HEMLOCK(ModBlock.HEMLOCK.get(), 1, ConfigFeatureControl.addFlora.get(), false, 12, BiomeTags.IS_FOREST),
        TITAN_ARUM(ModBlock.TITAN_ARUM.get(), 6, ConfigFeatureControl.addFlora.get(), false, 1, ModBiomeTags.IS_JUNGLE),
        ZIMBABWE_ALOE(ModBlock.ZIMBABWE_ALOE.get(), 4, ConfigFeatureControl.addFlora.get(), false, 1, ModBiomeTags.IS_BADLANDS),
    FLOWER_YARROW(ModBlock.YARROW.get(), 6, ConfigFeatureControl.addFlora.get(), false, 18, BiomeTags.IS_FOREST, ModBiomeTags.IS_PLAINS, ModBiomeTags.IS_MOUNTAIN),
    GRASS_JUNEGRASS(ModBlock.JUNEGRASS.get(), 8, ConfigFeatureControl.addFlora.get(), false, 18, ModBiomeTags.IS_PLAINS),
    CANOLA(ModBlock.CANOLA.get(), 6, ConfigFeatureControl.addFlora.get(), false, 12, ModBiomeTags.IS_PLAINS);
