...
public class ModVillagerTrades {
    ...
    public static class setupOffer implements VillagerTrades.ItemListing {
        ...
        public MerchantOffer getOffer(Entity entityIn, RandomSource rand) {
            return new MerchantOffer(new ItemCost(this.itemstackIn, this.stackSizeIn), Optional.empty(), new ItemStack(this.itemstackOut, this.stackSizeOut), this.maxUses, this.givenExp, this.priceMultiplier);
        }
    }
}
